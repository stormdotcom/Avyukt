...
''')
    try:
        ...
        if "y" in ask_for_icon:
            ...
            ask_for_apache = raw_input(Fore.CYAN + "\nAvyukt>: Do you want to copy the generated executable to Apache Server? y/n >> ")
            if "y" in ask_for_apache:
                subprocess.call("cp Output/dist/" + name + ".exe" + " /var/www/html/Generated/", shell=True)
                print("\n[+] Successfully copied the payload to Apache WebServer")
            if "n" in ask_for_apache:
                print("")
...
def list_info():
    ...
    print(Fore.WHITE + "\n\t\t[3] python/Avyukt/reverse_tcp " + Fore.RED + "(Python File)")
    print(Fore.RED + "\n\t\tAvyukt Payloads for Linux" + Fore.WHITE + " (Good)")
    print(Fore.WHITE + "\n\t\t[4] python/Avyukt/reverse_tcp (Linux)")
    ...
    print(Fore.WHITE + "\n\t\t[11] android/meterpreter/reverse_tcpz")
...
def details(version, Operating_System, release):
    print(Fore.GREEN + "\n[OK] " + Fore.WHITE + "Avyukt Version Build : " + Fore.WHITE + version)
    print(Fore.GREEN + "[OK] " + Fore.WHITE + "Checking for Output Directory!")
    time.sleep(3)
    if not os.path.exists("Output"):
        print(Fore.GREEN + "[OK] " + Fore.WHITE + "Output Directory was not found, Creating one")
        time.sleep(1)
        print(Fore.GREEN + "[OK] " + Fore.WHITE + "Creating Output Directory")
        time.sleep(1)
        os.mkdir("Output")
        time.sleep(1)
        print(Fore.GREEN + "[OK] " + Fore.WHITE + "Sucessfully created Output Directory!")
        time.sleep(1)
    else:
        print(Fore.GREEN + "[OK] " + Fore.WHITE + "Output Directory Found!")
        time.sleep(1)
    print(Fore.GREEN + "[OK] " + Fore.WHITE + "Checking for Apache Directory")
    time.sleep(1)
    if not os.path.exists("/var/www/html/Generated"):
        ...
        time.sleep(1)
    print(Fore.GREEN + "[OK] " + Fore.WHITE + "OS Release : " + release)
    time.sleep(1)
    print(Fore.GREEN + "[OK] " + Fore.WHITE + "Detected System Name : " + Fore.WHITE + Operating_System)
    time.sleep(1)
    print(Fore.GREEN + "[OK] " + Fore.WHITE + "All dependencies installed")
    time.sleep(1)
